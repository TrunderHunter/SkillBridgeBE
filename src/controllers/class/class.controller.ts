...
export class ClassController {
  ...
  static async createClassMaterial(
    req: AuthenticatedRequest,
    res: Response
  ) {
    try {
      ...
      const result = await classService.addClassMaterial(classId, tutorId, req.body);
      res.json(result);
    } catch (error: any) {
  ...
  static async updateClassMaterial(
    req: AuthenticatedRequest,
    res: Response
  ) {
    try {
  ...
  static async deleteClassMaterial(
    req: AuthenticatedRequest,
    res: Response
  ) {
    try {
      ...
      const result = await classService.deleteClassMaterial(classId, materialId, tutorId);
      res.json(result);
    } catch (error: any) {
  ...
  static async createClassAssignment(
    ...
    try {
      ...
      const result = await classService.createClassAssignment(classId, tutorId, req.body);
      res.json(result);
    } catch (error: any) {
  ...
  static async deleteClassAssignment(
    ...
    try {
      ...
      const result = await classService.deleteClassAssignment(classId, assignmentId, tutorId);
      res.json(result);
    } catch (error: any) {
  ...
  static async submitAssignmentWork(
    req: AuthenticatedRequest,
    res: Response
  ) {
    try {
